...
enum ObjectCategory_t {
	...
	OBJECTCATEGORY_FIST = 32,

	OBJECTCATEGORY_FIRST = OBJECTCATEGORY_ARMORS,
	OBJECTCATEGORY_LAST = OBJECTCATEGORY_FIST,
};
...
enum Vocation_t : uint16_t {
	...
	VOCATION_ORC = 2,
	VOCATION_ELF = 3,
	VOCATION_MORTOVIVO = 4,
	VOCATION_ANAO = 5,
	VOCATION_HUMANO_CLERIGO = 6,
	VOCATION_HUMANO_PALADINO = 7,
	VOCATION_HUMANO_MAGO = 8,
	VOCATION_HUMANO_VERETANO = 9,
	VOCATION_ORC_BARBARO = 10,
	VOCATION_ORC_LANCEIRO = 11,
	VOCATION_ORC_SHAMAN = 12,
	VOCATION_ORC_COMANDANTE = 13,
	VOCATION_ELF_ESCURIDAO = 14,
	VOCATION_ELF_SUMONADOR = 15,
	VOCATION_ELF_ASSASSINO = 16,
	VOCATION_ELF_ARQUEIRO = 17,
	VOCATION_MORTOVIVO_VAMPIRO = 18,
	VOCATION_MORTOVIVO_BANSHEE = 19,
	VOCATION_MORTOVIVO_MUMIA = 20,
	VOCATION_MORTOVIVO_CEIFADOR = 21,
	VOCATION_ANAO_MINEIRO = 22,
	VOCATION_ANAO_BESTEIRO = 23,
	VOCATION_ANAO_ALQUIMISTA = 24,
	VOCATION_ANAO_CRONOMANCER = 25,
	VOCATION_LAST = VOCATION_ANAO_CRONOMANCER,

	// Cip tibia client ids
	VOCATION_HUMANO_CIP = 1, //VOCATION_KNIGHT_CIP
	VOCATION_ORC_CIP = 2, //VOCATION_PALADIN_CIP
	VOCATION_ELF_CIP = 3, //VOCATION_DRUID_CIP
	VOCATION_MORTOVIVO_CIP = 4, //VOCATION_SORCERER_CIP
	VOCATION_ANAO_CIP = 5,
};
