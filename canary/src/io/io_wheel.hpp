...
public:
	...
	struct DataArray {
		...
		struct Spells {
			...
			std::array<Humano, 5> Humano;
			std::array<Orc, 5> Orc;
			std::array<Elf, 5> Elf;
			std::array<Mortovivo, 5> Mortovivo;
			std::array<Anao, 5> Anao;
		};
...
private:
	...
	/**
	 * @brief Initializes the spells for the humano race.
	 * @details This function sets up the spell information for the humano race in the wheel bonus data.
	 * @details It assigns names and specific grades of effects to each spell.
	 * @note Make sure to call this function before using humano spells.
	 */
	void initializeHumanSpells();

	/**
	 * @brief Initializes the spells for the orc race.
	 * @details This function sets up the spell information for the orc race in the wheel bonus data.
	 * @details It assigns names and specific grades of effects to each spell.
	 * @note Make sure to call this function before using orc spells.
	 */
	void initializeOrcSpells();

	/**
	 * @brief Initializes the spells for the elf race.
	 * @details This function sets up the spell information for the elf race in the wheel bonus data.
	 * @details It assigns names and specific grades of effects to each spell.
	 * @note Make sure to call this function before using elf spells.
	 */
	void initializeElfSpells();

	/**
	 * @brief Initializes the spells for the morto vivo race.
	 * @details This function sets up the spell information for the morto vivo race in the wheel bonus data.
	 * @details It assigns names and specific grades of effects to each spell.
	 * @note Make sure to call this function before using morto vivo spells.
	 */
	void initializeMortovivoSpells();

	/**
	 * @brief Initializes the spells for the anao race.
	 * @details This function sets up the spell information for the anao race in the wheel bonus data.
	 * @details It assigns names and specific grades of effects to each spell.
	 * @note Make sure to call this function before using anao spells.
	 */
	void initializeAnaoSpells();
	...
	/**
	 * @brief Checks if the vocation ID corresponds to a humano.
	 * @param vocationId The vocation ID to be checked.
	 * @return true if the vocation ID corresponds to a humano, false otherwise.
	 */
	bool isHumano(uint8_t vocationId) const;

	/**
	 * @brief Checks if the vocation ID corresponds to a orc.
	 * @param vocationId The vocation ID to be checked.
	 * @return true if the vocation ID corresponds to a orc, false otherwise.
	 */
	bool isOrc(uint8_t vocationId) const;

	/**
	 * @brief Checks if the vocation ID corresponds to a elf.
	 * @param vocationId The vocation ID to be checked.
	 * @return true if the vocation ID corresponds to a elf, false otherwise.
	 */
	bool isElf(uint8_t vocationId) const;

	/**
	 * @brief Checks if the vocation ID corresponds to a morto vivo.
	 * @param vocationId The vocation ID to be checked.
	 * @return true if the vocation ID corresponds to a morto vivo, false otherwise.
	 */
	bool isMortovivo(uint8_t vocationId) const;

	/**
	 * @brief Checks if the vocation ID corresponds to a anao.
	 * @param vocationId The vocation ID to be checked.
	 * @return true if the vocation ID corresponds to a anao, false otherwise.
	 */
	bool isAnao(uint8_t vocationId) const;
