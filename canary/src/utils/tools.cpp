...
std::string getPlayerSubjectPronoun(PlayerPronoun_t pronoun, PlayerRace_t sex, const std::string &name) {
	switch (pronoun) {
		...
		case PLAYERPRONOUN_NAME:
			return name;
		default:
			return sex == HUMAN ? "she" : "he";
	}
}

std::string getPlayerObjectPronoun(PlayerPronoun_t pronoun, PlayerRace_t sex, const std::string &name) {
	switch (pronoun) {
		case PLAYERPRONOUN_THEY:
			return "them";
		case PLAYERPRONOUN_SHE:
		...
		case PLAYERPRONOUN_NAME:
			return name;
		default:
			return sex == HUMAN ? "her" : "him";
	}
}

std::string getPlayerPossessivePronoun(PlayerPronoun_t pronoun, PlayerRace_t sex, const std::string &name) {
	switch (pronoun) {
		case PLAYERPRONOUN_THEY:
			return "their";
		case PLAYERPRONOUN_SHE:
		...
		case PLAYERPRONOUN_NAME:
			return name + "'s";
		default:
			return sex == HUMAN ? "her" : "his";
	}
}

std::string getPlayerReflexivePronoun(PlayerPronoun_t pronoun, PlayerRace_t sex, const std::string &name) {
	switch (pronoun) {
		case PLAYERPRONOUN_THEY:
			return "themself";
		case PLAYERPRONOUN_SHE:
		...
		case PLAYERPRONOUN_NAME:
			return name;
		default:
			return sex == HUMAN ? "herself" : "himself";
	}
}
