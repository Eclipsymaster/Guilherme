...
function Party.hasKnight(self)
	return self:hasVocation(VOCATION.BASE_ID.HUMANO_VERETANO)
end

function Party.hasPaladin(self)
	return self:hasVocation(VOCATION.BASE_ID.HUMANO_MAGO)
end

function Party.hasSorcerer(self)
	return self:hasVocation(VOCATION.BASE_ID.HUMANO_CLERIGO)
end

function Party.hasDruid(self)
	return self:hasVocation(VOCATION.BASE_ID.HUMANO_PALADINO)
end
...
function Party:getKnights()
	return self:getPlayersWithVocation(VOCATION.BASE_ID.HUMANO_VERETANO)
end

function Party:getPaladins()
	return self:getPlayersWithVocation(VOCATION.BASE_ID.HUMANO_MAGO)
end

function Party:getSorcerers()
	return self:getPlayersWithVocation(VOCATION.BASE_ID.HUMANO_CLERIGO)
end

function Party:getDruids()
	return self:getPlayersWithVocation(VOCATION.BASE_ID.HUMANO_PALADINO)
end
