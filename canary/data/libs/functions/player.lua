...
function Player.isHumano(self)
    return table.contains({ VOCATION.ID.HUMANO }, self:getVocation():getId())
end

function Player.isOrc(self)
    return table.contains({ VOCATION.ID.ORC }, self:getVocation():getId())
end

function Player.isElf(self)
    return table.contains({ VOCATION.ID.ELF }, self:getVocation():getId())
end

function Player.isMortovivo(self)
    return table.contains({ VOCATION.ID.MORTOVIVO }, self:getVocation():getId())
end

function Player.isAnao(self)
    return table.contains({ VOCATION.ID.ANAO }, self:getVocation():getId())
end

function Player.isClerigo(self)
    return table.contains({ VOCATION.ID.HUMANO_CLERIGO }, self:getVocation():getId())
end


function Player.isPaladino(self)
    return table.contains({ VOCATION.ID.HUMANO_PALADINO }, self:getVocation():getId())
end


function Player.isMago(self)
    return table.contains({ VOCATION.ID.HUMANO_MAGO }, self:getVocation():getId())
end


function Player.isVeterano(self)
    return table.contains({ VOCATION.ID.HUMANO_VERETANO }, self:getVocation():getId())
end


function Player.isBarbaro(self)
    return table.contains({ VOCATION.ID.ORC_BARBARO }, self:getVocation():getId())
end


function Player.isLanceiro(self)
    return table.contains({ VOCATION.ID.ORC_LANCEIRO }, self:getVocation():getId())
end


function Player.isShaman(self)
    return table.contains({ VOCATION.ID.ORC_SHAMAN }, self:getVocation():getId())
end


function Player.isComandante(self)
    return table.contains({ VOCATION.ID.ORC_COMANDANTE }, self:getVocation():getId())
end


function Player.isEscuridao(self)
    return table.contains({ VOCATION.ID.ELF_ESCURIDAO }, self:getVocation():getId())
end


function Player.isSumonador(self)
    return table.contains({ VOCATION.ID.ELF_SUMONADOR }, self:getVocation():getId())
end


function Player.isAssassino(self)
    return table.contains({ VOCATION.ID.ELF_ASSASSINO }, self:getVocation():getId())
end


function Player.isArqueiro(self)
    return table.contains({ VOCATION.ID.ELF_ARQUEIRO }, self:getVocation():getId())
end


function Player.isVampiro(self)
    return table.contains({ VOCATION.ID.MORTOVIVO_VAMPIRO }, self:getVocation():getId())
end


function Player.isBanshee(self)
    return table.contains({ VOCATION.ID.MORTOVIVO_BANSHEE }, self:getVocation():getId())
end


function Player.isMumia(self)
    return table.contains({ VOCATION.ID.MORTOVIVO_MUMIA }, self:getVocation():getId())
end


function Player.isCeifador(self)
    return table.contains({ VOCATION.ID.MORTOVIVO_CEIFADOR }, self:getVocation():getId())
end


function Player.isMineiro(self)
    return table.contains({ VOCATION.ID.ANAO_MINEIRO }, self:getVocation():getId())
end


function Player.isBesteiro(self)
    return table.contains({ VOCATION.ID.ANAO_BESTEIRO }, self:getVocation():getId())
end


function Player.isAlquimista(self)
    return table.contains({ VOCATION.ID.ANAO_ALQUIMISTA }, self:getVocation():getId())
end


function Player.isCronomancer(self)
    return table.contains({ VOCATION.ID.ANAO_CRONOMANCER }, self:getVocation():getId())
end

--[[function Player.isMage(self)
	return table.contains({ VOCATION.ID.HUMANO_CLERIGO, VOCATION.ID.HUMANO_PALADINO }, self:getVocation():getId())
end]]
...
function Player.getSubjectPronoun(self)
	return Pronouns.getPlayerSubjectPronoun(self:getPronoun(), self:getPlayerRace(), self:getName())
end

function Player.getObjectPronoun(self)
	return Pronouns.getPlayerObjectPronoun(self:getPronoun(), self:getPlayerRace(), self:getName())
end

function Player.getPossessivePronoun(self)
	return Pronouns.getPlayerPossessivePronoun(self:getPronoun(), self:getPlayerRace(), self:getName())
end
