local mType = Game.createMonsterType("Demônio Esqueleto")
local monster = {}

monster.description = "um demônio esqueleto"
...
monster.loot = {
	...
	{ id = 3027, chance = 2900 }, -- pérola negra
	...
	{ id = 3415, chance = 100 }, -- escudo do guardião
	{ id = 266, chance = 10120, maxCount = 2 }, -- poção de vida
	{ id = 266, chance = 10000, maxCount = 2 }, -- poção de vida
	{ id = 268, chance = 5300 }, -- poção de mana
	{ id = 9647, chance = 12600 }, -- mão demoníeca
}
