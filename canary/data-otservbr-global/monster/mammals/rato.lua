local mType = Game.createMonsterType("Rato")
local monster = {}

monster.description = "um rato"
...
monster.loot = {
	{ id = 3031, chance = 100000, maxCount = 4 }, -- moeda de ouro
	{ id = 3607, chance = 39410 }, -- queijo meia cura
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -8 },
	--{ name = "roubar", interval = 2000, chance = 100 },
}
