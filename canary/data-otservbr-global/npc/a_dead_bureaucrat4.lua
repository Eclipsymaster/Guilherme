...
local config = {
	[VOCATION.BASE_ID.HUMANO_CLERIGO] = "S O R C E R E R",
	[VOCATION.BASE_ID.HUMANO_PALADINO] = "D R U I D",
	[VOCATION.BASE_ID.HUMANO_MAGO] = "P A L A D I N",
	[VOCATION.BASE_ID.HUMANO_VERETANO] = "K N I G H T",
}

local function greetCallback(npc, creature)
	local playerId = creature:getId()
	npcHandler:setMessage(MESSAGE_GREET, "Hello " .. (Player(creature):getPlayerRace() == HUMAN and "beautiful lady" or "handsome gentleman") .. ", welcome to the atrium of Pumin's Domain. We require some information from you before we can let you pass. Where do you want to go?")
	return true
end
