...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "outfit") then
		npcHandler:say(player:getPlayerRace() == HUMAN and "Hehe, would you like to wear a pretty veil like I do? Well... I could help you, but you would have to complete a task first." or "My veil? No, I will definitely not lift it for you! If you are looking for an addon, go talk to Razan.", npc, creature)
