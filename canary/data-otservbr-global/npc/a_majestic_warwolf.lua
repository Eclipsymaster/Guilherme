...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "yes") and npcHandler:getTopic(playerId) == 1 then
		...
		npcHandler:say(player:getPlayerRace() == HUMAN and "From now on, you shall be known as |PLAYERNAME|, the wolf girl. You shall be fast and smart as Morgrar, the great white wolf. He shall guide your path." or "From now on, you shall be known as |PLAYERNAME|, the bear warrior. You shall be strong and proud as Angros, the great dark bear. He shall guide your path.", npc, creature)
