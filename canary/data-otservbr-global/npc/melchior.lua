...
local function greetCallback(npc, creature)
	...
	npcHandler:setMessage(MESSAGE_GREET, Player(creature):getPlayerRace() == HUMAN and "Welcome, |PLAYERNAME|! The lovely sound of your voice shines like a beam of light through my solitary darkness!" or "Greetings, |PLAYERNAME|. I do not see your face, but I can read a thousand things in your voice!")
	return true
end
