...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "crest") then
		if player:hasOutfit(player:getPlayerRace() == HUMAN and 336 or 335) and player:getItemCount(10199) > 0 then
		...
		elseif player:hasOutfit(player:getPlayerRace() == HUMAN and 336 or 335) and player:getItemCount(10198) > 0 then
	...
	elseif MsgContains(message, "yes") and npcHandler:getTopic(playerId) >= 60 and npcHandler:getTopic(playerId) <= 61 then
		if npcHandler:getTopic(playerId) == 60 then
			if not player:hasOutfit(player:getPlayerRace() == HUMAN and 336 or 335, 1) and player:removeItem(10199, 1) then
		...
		elseif npcHandler:getTopic(playerId) == 61 then
			if not player:hasOutfit(player:getPlayerRace() == HUMAN and 336 or 335, 2) and player:removeItem(10198, 1) then
