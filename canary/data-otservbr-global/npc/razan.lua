...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "outfit") then
		npcHandler:say(player:getPlayerRace() == HUMAN and "My turban? I know something better for a pretty girl like you. Why don't you go talk to Miraia?" or "My turban? Eh no, you can't have it. Only oriental weaponmasters may wear it after having completed a difficult task.", npc, creature)
