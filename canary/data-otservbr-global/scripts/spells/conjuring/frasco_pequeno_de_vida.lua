...
function spell.onCastSpell(creature, variant)
	...
	if health < 121 then 
		...
		if creature:getItemCount(285) ~= 0 then
			creature:setHealth(health - 120)
			creature:conjureItem(285, 7876, 1, CONST_ME_REDTELEPORT)
			return true
		else
...
spell:name("Frasco pequeno de vida")
spell:words("enfrascar pouca vida")
spell:group("support")
spell:vocation("Humano;true", 
				"Orc;true", 
				"Elf;true", 
				"Morto-vivo;true", 
				"Anao;true", 
