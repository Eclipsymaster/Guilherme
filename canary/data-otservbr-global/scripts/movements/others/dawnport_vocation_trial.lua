...
local vocationTrials = {
	...
	[25005] = {
		...
		message = "Agora você é um humano, o mesmo podendo se tornar um {Clerigo}, {Paladino}, {Mago} e {Ninja}.",
		vocation = {
			id = VOCATION.ID.HUMANO,
			name = "Humano",
			outfit = {
				lookType = {
					[HUMAN] = 138,
	...
	[25006] = {
		...
		vocation = {
			id = VOCATION.ID.HUMANO_PALADINO,
			name = "druid",
			outfit = {
				lookType = {
					[HUMAN] = 138,
	...
	[25008] = {
		...
		vocation = {
			id = VOCATION.ID.HUMANO_VERETANO,
			name = "knight",
			outfit = {
				lookType = {
					[HUMAN] = 139,
...
local function setOutfit(player, outfit)
	player:setOutfit({
		lookTypeEx = 0,
		lookType = outfit.lookType[player:getPlayerRace()],
