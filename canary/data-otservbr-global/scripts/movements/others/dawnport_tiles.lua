local chestRooms = {
	...
	exits = {
		[25014] = { vocation = VOCATION.ID.HUMANO_CLERIGO, destination = { x = 32054, y = 31879, z = 6 } },
		[25015] = { vocation = VOCATION.ID.HUMANO_PALADINO, destination = { x = 32073, y = 31879, z = 6 } },
		[25016] = { vocation = VOCATION.ID.HUMANO_MAGO, destination = { x = 32059, y = 31879, z = 6 } },
		[25017] = { vocation = VOCATION.ID.HUMANO_VERETANO, destination = { x = 32068, y = 31879, z = 6 } },
	},
}
