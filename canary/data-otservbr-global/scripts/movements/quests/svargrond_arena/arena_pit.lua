...
function arenaPit.onStepIn(creature, item, position, fromPosition)
	...
	if occupant then
		player:sendTextMessage(MESSAGE_EVENT_ADVANCE, occupant:getName() .. " is currently in the next arena pit. Please wait until " .. (occupant:getPlayerRace() == HUMAN and "s" or "") .. "he is done fighting.")
