local setting = {
	[1062] = { destination = Position(33085, 32096, 13), vocation = VOCATION.BASE_ID.HUMANO_VERETANO, storage = 10130 },
	[1063] = { destination = Position(33264, 32201, 13), vocation = VOCATION.BASE_ID.HUMANO_MAGO, storage = 10131 },
	[1064] = { destination = Position(33330, 32077, 13), vocation = VOCATION.BASE_ID.HUMANO_PALADINO, storage = 10132 },
	[1065] = { destination = Position(33183, 32198, 13), vocation = VOCATION.BASE_ID.HUMANO_CLERIGO, storage = 10133 },
}
