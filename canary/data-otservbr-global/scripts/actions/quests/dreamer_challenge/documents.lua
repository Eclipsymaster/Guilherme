...
function dreamerDocuments.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if choice.addon then
		if player:hasOutfit(player:getPlayerRace() == HUMAN and choice.female or choice.male) then
			if not player:hasOutfit(player:getPlayerRace() == HUMAN and choice.female or choice.male, choice.addon) then
		...
		if not player:hasOutfit(player:getPlayerRace() == HUMAN and choice.female or choice.male) then
