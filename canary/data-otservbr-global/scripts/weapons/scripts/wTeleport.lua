...
wTeleport.onUseWeapon = function(player, variant)
	...
	player:say("Calculo da skill: "..skillChance.."\nChance random: "..chance)
	--player:sayprint("Cd storage:".. config.cooldownStorage)
	--player:sayprint("Cd:".. config.cooldownPassive)
...
wTeleport:id(7403) -- ItemId
wTeleport:vocation("Paladino", true, true) -- Vocation, showDescription, lastVoc
